...
async function getImageCached(fileId){
  ...
  const apiUrl =
    'https://script.google.com/macros/s/AKfycbwYNzCnG9mmtSG3m6mZBoyK706_M2x5anODuu1jVPQh1k_Kma3KipZqy725i4XjXNth/exec?image='
    + fileId;
...
function saveSettings(){
  ...
  localStorage.setItem("hitomojiSettings", JSON.stringify({
    sound: sound,
    order: order
  }));
...
function getSettings() {
  ...
  const settings = Object.assign(
    ...
    JSON.parse(localStorage.getItem("hitomojiSettings")) || {}
  );
...
async function initApp() {
  ...
  const response = await fetch(
    'https://script.google.com/macros/s/AKfycbwYNzCnG9mmtSG3m6mZBoyK706_M2x5anODuu1jVPQh1k_Kma3KipZqy725i4XjXNth/exec'
  );
